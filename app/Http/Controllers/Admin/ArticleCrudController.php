...
class ArticleCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('image')->type('image')->label('Ảnh');;
        CRUD::column('title')->type('editable_text')->label('Tên');
        CRUD::column('status')->label('Trạng thái');;
        CRUD::column('featured');
        CRUD::column('date')->type('datetime')->label('Ngày Tháng');;
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('category_id')->type('hidden')->value(1);;
        CRUD::field('title')->type('text')->validationRules('min:10');
