...
{{--        </ul>--}}
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('banner') }}'><i class="nav-icon las la-images"></i> Banners</a></li>
<li class="nav-item nav-dropdown">
        <a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon las la-bars"></i>Nội dung </a>
        <ul class="nav-dropdown-items">
                <li class='nav-item'><a class='nav-link' href='{{ backpack_url('article') }}'>
                                <i class="nav-icon las la-newspaper"></i>Slider</a></li>
