            ...
            <div class="multiple-items">
                @foreach( $articles as $article)
                    <div class="card" style="">
                        ...
                        @else
                            <img src="https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg" class="card-img-top ps-5 pe-5 pt-5" alt="">
                        @endif
                        <div class="card-body ps-5 pe-5">
                            <h5 class="card-title" style="">{{ $article->title}}</h5>
                            <p class="card-text text-white mt-5 d-none d-md-block" style="">{!! Str::limit(strip_tags($article->content)) !!}</p>
                        </div>
                    </div>
                @endforeach
            </div>
